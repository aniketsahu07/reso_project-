...
export default function Login() {
  ...
  return (
    <main className="main-content" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 'calc(100vh - 80px)' }}>
      <div className="panel" style={{ padding: '48px 40px', maxWidth: '450px', width: '100%', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        
        <div style={{ background: 'var(--semantic-primary-bg)', width: '64px', height: '64px', borderRadius: 'var(--radius-md)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px auto', color: 'var(--semantic-primary)' }}>
          <Shield size={32} />
        </div>
        
        <h1 style={{ fontSize: '2rem', marginBottom: '12px' }}>Sign in to ProjectHub</h1>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '40px', lineHeight: 1.6 }}>
          Sign in to access projects, teams, and your dashboard.
        </p>
        ...
        <button 
          ...
          style={{ width: '100%', padding: '16px', fontSize: '1.1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', background: 'var(--text-white)', color: 'var(--bg-main)', border: '1px solid var(--border-subtle)', boxShadow: 'var(--shadow-google)' }}
        >
        ...
        <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginTop: '32px' }}>
          By continuing, you agree to the ProjectHub terms.
        </p>
